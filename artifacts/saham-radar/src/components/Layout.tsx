...
import { TrendingUp, Settings, Menu, X, Zap, Lock, Bitcoin, Bot } from "lucide-react";
...
const navItems = [
  ...
  { href: "/quant-bot", label: "Quant Bot", sublabel: "3-brain autonomous trader", icon: Bot, role: "admin" as const },
